...
<%
	try{
		...
		sql = "select t.team_no, t.team_name, t.team_intro, concat(t.main_genre, ',', t.code_genre) as genre, t.code_area, fa.kurl, fa.ktel, fa.kcountmin, fa.kcountmax, fa.kemail, fa.kbirth" + "\r\n" +
				"from team t" + "\r\n" +
				"left join festival_apply fa on fa.kteamno = t.team_no" + "\r\n" +
				"where t.team_no = '"+tno+"'" + "\r\n";
		...
		if(rs.next()){
			...
			<DATA>
				...
				<BIRTH><%=ConvertUtil.toStr(rs.getString("KBIRTH"))%></BIRTH>
