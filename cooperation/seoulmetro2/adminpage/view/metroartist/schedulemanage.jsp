...
<script type="text/javascript" src="/cooperation/seoulmetro/adminpage/resource/js/active/schedulemanage.js?ver=1.0.4" ></script>
<body>
	<nav class="middle_wapper schedulemanage_wapper">
	<%@include file="/cooperation/seoulmetro/adminpage/tracker/header.jsp" %>
	<nav class="middle schedulemanage">
		<div class="middle_title_wapper flex">
			<p class="ft_20 ft_medium">일정관리</p>
			<select class="ft_14">
				<option selected="selected">전체</option>
			</select>
		</div>
		<div class="middle_cell_wapper">
			<table id="schedulemanage_table">
			</table>
		</div>
