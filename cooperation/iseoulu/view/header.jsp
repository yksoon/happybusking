<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String headerImagePath = "/cooperation/iseoulu/img";
...
%>
<%if(mainPathChk.equals("index.jsp") || mainPathChk.equals("iseoulu")) {%>
<!-- 메인부분 헤더 -->
<header>
	<div class="header_wapper">
		<div class="hw_image_container" onclick="location.href='/cooperation/iseoulu'"><img src="<%=headerImagePath %>/logo.png"></div>
