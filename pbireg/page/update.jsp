...
<script type="text/javascript" src="/pbireg/resource/js/active/update.js?ver=1.0.0" ></script>
...
<body>
	...
	<nav class="indexWrapper">
		...
		<input type="text" id="change-image" data-role="none" readonly="readonly" placeholder="이미지를 선택해주세요." onclick="changeImage();">
		<input type="file" id="image" data-role="none" accept=".jpg,.jpeg,.png,.bmp">
		...
		<div class="btn_b" id="apply" onClick="pbiUpdate();">
			수정 완료
		</div>
