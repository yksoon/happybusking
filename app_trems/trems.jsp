...
<head>
<title>해피버스킹-개인정보처리방침</title>
</head>
<body>
				<p class="termsTitle">개인정보처리 및 취급 방침</p>

			<p>본 해피버스킹 개인정보취급방침은 비즈웍스(이하 “회사”)가 www.happybusking.com (이하 “해피버스킹”) 이용자들의 개인정보보호를 매우 중요시하며, 이용자가 회사의 서비스를 이용함과 동시에 온라인상에서 회사에 제공한 개인정보가 보호 받을 수 있도록 최선을 다하고 있습니다. 이에 “해피버스킹”은 통신비밀보호법, 전기통신사업법, 정보통신망 이용촉진 및 정보보호 등에관한 법률 등 정보통신서비스제공자가 준수하여야 할 관련 법규상의 개인정보보호 규정 및정보통신부가 제정한 개인정보보호지침을 준수하고 있습니다.</p>
			...
			<p class="termsTitle2">② 서비스 제공에 관한 계약 이행</p>
			<p>콘텐츠 제공, 특정 맞춤 서비스 제공, 물품배송, 본인인증</p>
			<p class="termsTitle2">③ 신규서비스 개발 및 마케팅 광고 활용</p>
			...
			<p class="termsTitle2">① 수집하는 개인정보 항목</p>
			<p> 1. 로그인시 :</p>
			...
			<p class="termsTitle2">①해피버스킹은 이용자가 회사에서 제공하는 서비스를 이용하는 동안 이용자들의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다.</p>
			<p class="termsTitle2">② 이용자의 개인정보는 개인정보의 수집목적 또는 제공받은 목적이 달성되면 파기하는 것을 원칙으로 합니다. 다만, 해피버스킹 불량 이용자의 부정한 이용의 재발을 방지하기 위해 이용계약 해지일로부터 1년간 해당 이용자의 정보를 보유할 수 있습니다.</p>
			<p class="termsTitle2">③상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 해피버스킹은 관계법령에 정한 일정한 기간 동안 아래 각 호와 같이 이용자 정보를 보관합니다.</p>
			<p class="termsTitle2"> 1. 계약 또는 청약철회 등에 관한 기록<br>
			    보존이유 : 전자상거래 등에서의 소비자보호에 관한 법률<br>
			    보존기간 : 5년</p>
			<p class="termsTitle2"> 2. 대금결제 및 재화 등의 공급에 관한 기록<br>
			    보존이유 : 전자상거래 등에서의 소비자보호에 관한 법률<br>
			    보존기간 : 5년</p>
			<p class="termsTitle2"> 3. 소비자의 불만 또는 분쟁처리에 관한 기록<br>
			    보존이유 : 전자상거래 등에서의 소비자보호에 관한 법률<br>
			    보존기간 : 5년</p>
			<p class="termsTitle2"> 4. 웹 또는 앱 방문기록<br>
			    보존이유 : 통신비밀보호법<br>
			    보존기간 : 3개월</p>
			 <p class="termsTitle2">5. 표시. 광고에 관한 기록<br>
			...
			<p class="termsTitle2">① 이용자는 자신의 개인정보를 최신의 상태로 유지해야 하며, 이용자의 부정확한 정보 입력으로 발생하는 문제의 책임은 이용자 자신에게 있습니다.</p>
			<p class="termsTitle2">② 이용자는 회사의 서비스를 이용한 후에는 반드시 로그인 계정을 종료하고 프로그램을 종료해야 합니다.</p>
			<p class="termsTitle2">③ 이용자는 정보통신망이용촉진 및 정보보호 등에 관한 법률, 개인정보보법 등 기타 개인정보에 관한 법률을 준수하여야 합니다.</p>
			
			<p class="termsTitle">제9조. 링크사이트</p>
			<p class="termsTitle2">① 회사는 해피버스킹을 통해 이용자에게 다른 회사의 웹사이트 또는 앱, 자료에 대한 링크를 제공할 수 있습니다. 이 경우 회사는 외부사이트 및 자료에 대한 아무런 통제권이 없으므로 그로부터 제공받는 서비스나 자료의 신뢰성에 대해 책임질 수 없으며 어떠한 보증도 할 수 없습니다.</p>
			<p class="termsTitle2">② 해피버스킹이 포함하고 있는 링크를 클릭하여 타 사이트의 페이지로 옮겨갈 경우 해당 사이트의 갸인정보취급방침은 해피버스킹과는 무관하므로 새로 방문한 사이트의 정책을 검토하시기 바랍니다.</p>
