...
<script type="text/javascript" src="/recruit/resource/js/active/join.js?ver=1.0.1" ></script>
...
<body  onload="onLoad();">
	...
	<nav class="wrapper">
		...
		<nav class="h-pt join-warpper" style="margin-top: 50px;">
			...
			<div class="bg-purple ft-white ft-16 ft-bold btn" id="join" onclick="handlerNaverJoin();">등록 완료</div>
		</nav>
