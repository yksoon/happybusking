...
<html>
<head>
<link type="text/css" rel="stylesheet" href="/recruit/resource/css/reg.css?ver=1.0.6" />
<script type="text/javascript" src="/recruit/resource/js/function/reg-func.js?ver=1.0.8" ></script>
<script type="text/javascript" src="/recruit/resource/js/function/mypbi-func.js?ver=1.0.2" ></script>
<script type="text/javascript" src="/recruit/resource/js/active/reg.js?ver=1.0.7" ></script>
<script type="text/javascript" src="/recruit/resource/js/active/mypbi-update.js?ver=1.0.7" ></script>
...
<body  onload="onLoad();">
	...
	<nav class="wrapper">
		...
		<nav class="p-pt reg-warpper">
			...
			<!-- <p class="ft-lgray ft-12 subtitle">공연장 이미지 업로드 <span class="ft-gray ft-12">최대 10장</span></p> -->
			...
			<div class="flex img-container hall-contaienr">
			...
			<!-- <p class="ft-lgray ft-12 subtitle">상품 이미지 업로드 <span class="ft-gray ft-12">최대 10장</span></p> -->
			...
			<div class="flex img-container product-contaienr">
			...
			<div class="bg-purple ft-white btn ft-16 ft-bold" id="apply" onClick="handlerPbiUpdate();">
				수정 완료
			</div>
			...
			<div class="loading-popup" id="apply-popup">
				<div class="apply-container bg-white">
					<div class="ap-top" onclick="goMyPbi();"><img id="ap-close" src="/recruit/resource/img/common/close-gray.png" /></div>
					<div class="ap-body">
						<p class="ft-black ft-18 ft-bold">수정 완료</p>
						<p class="ft-lgray ft-14 ap-content">모집 공고가 수정 되었습니다.</p>
