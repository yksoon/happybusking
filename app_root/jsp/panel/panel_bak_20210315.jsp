		...
		<nav class="p-body-container">
			<div class="pb-menu-container pb-common-box">
				...
				<div class="pb-menu pb-icon-menu" onclick="goPublicBuskingInfoList();">
					<div class="pi-left">
						<span class="pm-text">아티스트 모집 정보</span>
				...
				<div class="pb-menu pb-icon-menu" onclick="goPublicBuskingInfoList();">
					<div class="pi-left">
						<span class="pm-text">공연/행사 정보</span>
						<img class="pm-back-icon" id="pbi_new_image" src="/img/panel_v2/NEW.svg"/>
					</div>
				</div>
				<%} %>
				<div class="pb-menu pb-icon-menu" onclick="go_perform_schedule();">
					<span class="pm-text">공연 일정</span>
				</div>
				<div class="pb-menu pb-icon-menu" onclick="go_artist_ranking();">
					<span class="pm-text">팀·솔로 리스트</span>
				</div>
				<div class="pb-menu pb-icon-menu" onclick="go_artist_become();">
					<span class="pm-text">아티스트 되기</span>
				</div>
				<div class="pb-menu pb-icon-menu" onclick="goTipboxList();">
					<span class="pm-text">모바일팁박스</span>
				</div>
				<div class="pb-menu pb-icon-menu" onclick="go_pfr_search();">
					<span class="pm-text">공연요청</span>
				</div>
				<div class="pb-menu pb-icon-menu" onclick="goBuskingzoneList();">
					<div class="pi-left">
						<span class="pm-text">버스킹존</span>
						<img class="pm-back-icon" id="bz_new_image" src="/img/panel_v2/NEW.svg"/>
					</div>
				</div>
				<div class="pb-menu pb-icon-menu" onclick="goShareItemList();">
					<div class="pi-left">
						<span class="pm-text">공연 장비 렌탈</span>
						<img class="pm-back-icon" id="si_new_image" src="/img/panel_v2/NEW.svg"/>
					</div>
				</div>
			</div>
			...
			<div class="pb-menu pb-title-menu" id="p-artist">
				<span class="pt-text">Artist</span>
			...
			<div class="pb-menu-container pb-artist-box p-artist p-off">
			<%} %>
				<div class="pb-menu pb-icon-menu pb-first-menu" onclick="go_pbi_condition();">
					<div class="pi-left">
				...
				<div class="pb-submenu-container p-commu">
				...
				<div class="pb-menu pb-icon-menu pb-top-menu" id="p-team">
					<div class="pi-left">
				...
				<div class="pb-menu pb-icon-menu" onclick="go_thanks_people();">
					<div class="pi-left">
						<span class="pm-text">후원 받은 내역</span>
					</div>
				</div>
