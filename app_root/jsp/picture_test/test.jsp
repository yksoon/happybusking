...
%><%
	String filePath = "D://heartpay/workspace/HeartPay/web/app_root/testImg/test.jpg";
    ...
    try {
        String sUploadPath    = "D://heartpay/workspace/HeartPay/web/app_root/testImg";
        ...
        multi =  new MultipartRequest(request, sUploadPath, 50*1024*1024, enc, new DefaultFileRenamePolicy());
        ...
        while (e.hasMoreElements()) {
            ...
            if (sOrgFileName != null && !"".equals(sOrgFileName)) {
                ...
                //}
                f.renameTo(new File(sUploadPath + "/" + sTempFile + ".jpg"));
