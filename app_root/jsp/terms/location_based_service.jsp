...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="location_based_service">
	<div class="common_trems_close_btn" id="terms_popup_close"><img src="/img/common/close.png"></div>
	<p class="termsTitle">위치기반 서비스 이용 약관</p>
			
			<p class="termsTitle">제1조. 목적</p>
			<p>본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)이 주식회사 가치누리(이하 “회사”라고 합니다)가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.	</p>
			
			<p class="termsTitle">제2조. 약관의 효력 및 변경</p>
			...
			<p class="termsTitle">제3조. 약관 외 준칙</p>
			...
			<p class="termsTitle">제4조. 서비스의 가입</p>
			...
			<table>
				...
				<tr>
					<td rowspan="2">정보제공<br>서비스</td>
					<td>네이버 지도</td>
					<td>장소검색, 위치정보 등 기능을 제공하는 지도 서비스</td>
					<td>- 공연 장소 위치 정보, 버스킹존 위치 정보, 버스킹 물품 공유 위치 정보<br>
						- 위치를 기반으로 한 회사의 개인화 서비스 제공<br>
						*개인의 위치정보는 회원 탈퇴 시 지체없이 파기</td>
					<td>무료</td>
				</tr>
				<tr>
					<td>다음 길찾기</td>
					<td>길찾기 기능을 제공하는 서비스</td>
					<td>- 현재 위치에서 주변 검색 및 경로찾기</td>
					<td>무료</td>
				</tr>
			</table>
			
			<p class="termsTitle">제7조. 서비스 이용요금</p>
			<p>회사가 제공하는 서비스는 기본적으로 유료 또는 무료입니다. 단, 별도의 유료서비스의 경우 해당 서비스에 명시된 요금을 지불하여야 사용 가능합니다.</p>
			<p>회사는 유료서비스 이용요금을 회사와 계약한 전자지불업체에서 정한 방법에 의하거나 회사가 정한 청구서에 합산하여 청구할 수 있습니다.</p>
			...
			<p class="termsTitle">제8조. 서비스의 이용제한 및 중지</p>
			...
			<p class="termsTitle">제9조. 서비스내용변경 통지 등</p>
			...
			<p class="termsTitle">제10조. 개인위치정보의 이용 또는 제공</p>
			...
			<p>회사는 타사업자 또는 이용 고객과의 요금정산 및 민원처리를 위해 위치정보 이용·제공, 사실 확인자료를 자동 기록·보존하며, 해당 자료는 6개월간 보관합니다.</p>
			...
			<p class="termsTitle">제11조. 개인위치정보주체의 권리</p>
			...
			<p class="termsTitle">제12조. 법정대리인의 권리</p>
			...
			<p class="termsTitle">제13조. 8세 이하의 아동 등의 보호의무자의 권리</p>
			<p>회사는 아래의 경우에 해당하는 자(이하 “8세 이하의 아동 등”이라고 합니다)의 보호의무자가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보의 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.</p>
			<p>8세 이하의 아동</p>
			<p>피성년후견인</p>
			...
			<p>1) 8세 이하의 아동의 법정대리인 또는 보호시설에 있는 미성년자의 후견 직무에 관한 법률 제3조의 규정에 따른 후견인</p>
			<p>2) 피성년후견인의 법정대리인</p>
			<p>3) 본 조 제1항 제3호의 자의 법정대리인 또는 장애인복지법 제58조 제1항 제1호의 규정에 따른 장애인생활시설(국가 또는 지방자치단체가 설치·운영하는 시설에 한합니다)의 장, 정신보건법 제3조 제4호의 규정에 따른 정신질환자 사회복귀시설(국가 또는 지방자치단체가 설치·운영하는 시설에 한합니다)의 장, 동법 동조 제5호의 규정에 따른 정신요양시설의 장</p>
			...
			<p class="termsTitle">제14조. 회사의 주소 및 연락처 등</p>
			<p>회사의 상호, 주소 및 연락처는 아래와 같습니다.</p>
			<p>상호 : 주식회사 가치누리</p>
			<p>대표 : 박준영</p>
			<p>주소 : 서울특별시 영등포구 여의대방로 67길 11 잡지회관빌딩6층 (여의도동 44-31)</p>
			<p>대표전화 : 02-780-2328</p>
			<p>회사는 개인위치정보를 적절히 관리·보호하고, 개인위치정보주체의 불만을 원활히 처리할 수 있도록 실질적인 책임을 질 수 있는 지위에 있는 자를 위치정보관리책임자로 지정해 운영하고 있으며, 위치정보관리책임자의 성명과 연락처는 아래와 같습니다.</p>
			<p>성명 : 용광순</p>
			<p>대표전화 : 02-780-2328</p>
			<p>이메일주소 : chkue2@bizworks.co.kr</p>
			
			<p class="termsTitle">제15조. 양도금지</p>
			<p>회원의 서비스 받을 권리는 이를 양도 내지 증여하거나 담보제공 등의 목적으로 처분할 수 없습니다.	</p>
			
			<p class="termsTitle">제16조. 손해배상</p>
