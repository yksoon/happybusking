...
<div data-role="page" id="complete_end_busking" >
	<!-- header 부분 -->
    ...
    <%-- body부분 --%>
    <div id="complete_end_busking_content" data-role="content" >
        ...
        <p class="txt-title">모집 마감 완료</p>

        <div class="ui-line-a"></div>

        <p class="txt-middle-a">공연 모집이 마감 처리되었습니다</p>
