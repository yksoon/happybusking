...
<div data-role="page" id="complete_sign_contract_artist" >
	<!-- header 부분 -->
    ...
    <%-- body부분 --%>
    <div id="complete_sign_contract_artist" data-role="content" >
        ...
        <p class="txt-middle-b">전자 계약이 완료되어 사업자에게 정상적으로 전달되었습니다.</p>
        <div class="ui-line-b"></div>

        <p class="txt-contents-b">등록된 이메일에 계약서 사본이 전송되었습니다.</p>
