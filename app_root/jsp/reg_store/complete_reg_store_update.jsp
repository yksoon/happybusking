...
<div data-role="page" id="complete_reg_store_update" >
	<!-- header 부분 -->
    ...
    <%-- body부분 --%>
    <div id="complete_reg_store_update" data-role="content" >
        ...
        <p class="txt-title">수정 완료</p>
        <div class="ui-line-a"></div>
        <p class="txt-middle-c">공연 모집 정보가 수정되었습니다.</p>
