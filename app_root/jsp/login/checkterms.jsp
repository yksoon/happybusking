	...
	<div data-role="content">
		...
		<div class="common_terms_container">
			<div class="common_terms_all_check common_flex_container">
				<input type="checkbox" id="f_total_checkbox" data-role="none">
				<label for="f_total_checkbox">아래 약관에 모두 동의합니다</label>
			</div>
			<div class="common_terms_check common_flex_container">
					<input type="checkbox" id="f_useAgree_checkbox" data-role="none">
					<label for="f_useAgree_checkbox">이용약관 동의(필수)</label>
					<div class="common_terms_view_more" id="terms_of_service_view">보기</div>
			</div>
			<div class="common_terms_check common_flex_container">
					<input type="checkbox" id="f_info_checkbox" data-role="none">
					<label for="f_info_checkbox">개인정보 처리 및 취급방침 동의(필수)</label>
					<div class="common_terms_view_more" id="personal_info_view">보기</div>
			</div>
			<div class="common_terms_check common_flex_container">
					<input type="checkbox" id="f_useGPS_checkbox" data-role="none">
					<label for="f_useGPS_checkbox">위치기반 서비스 이용약관(필수)</label>
