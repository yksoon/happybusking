	...
	try{
		...
		pstmt = conn.createStatement();
 			...
 			sql = "UPDATE PERFORM_REQUEST" + "\r\n" +
					 "SET PF_REQUEST_STATE = 'Y', PF_REQUEST_RE_DATE = '{request_date}', PF_REQUEST_RE_TIME = '{request_time}'" + "\r\n" +
			...
			sql2 = "SELECT T.TEAM_NAME, MIN(PF_REQUEST_SDATE) AS MIN_DATE, MAX(PF_REQUEST_SDATE) AS MAX_DATE, U.FCM_TOKEN" + "\r\n" +
			        ...
			        "WHERE PRQ.TEAM_NO = T.TEAM_NO" + "\r\n" +
			          ...
			          "AND PRQ.PF_REQUEST_GRP_NO = " + prq_grp_no + "\r\n" +
			        "GROUP BY PF_REQUEST_GRP_NO" + "\r\n";
			...
			if(rs.next()){
				...
				String data = "'" + team_name + "' 아티스트가  요청하신 공연 의뢰" + date + "를 수락하였습니다";
