...
<%@page import="com.daou.auth.gamecard.DaouGameCardAPI"%>
...
<%
	//String IP	= "123.140.121.205"; //dev
	String IP	= "27.102.213.207"; 	//real
	int PORT = 57001;				//취소서버 포트
	
	String PAYMETHOD = request.getParameter("PAYMETHOD");
	
	if(PAYMETHOD.equals("HAPPYMONEY")){
		PORT = 50001;
	} else if(PAYMETHOD.equals("BOOK")){
		PORT = 55001;
...
<%
	...
	DaouGameCardAPI payGameCard = new DaouGameCardAPI(IP,PORT);
	...
	struct = payGameCard.GameCardCancel(struct, PubS_LOGDIR+"/"+CPID);
