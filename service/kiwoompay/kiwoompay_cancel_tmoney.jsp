...
<%@ page import="com.daou.auth.tmoney.*" %>
...
<%
	//String PubS_TMONEY_IP  = "123.140.121.205"; //개발서버IP
	String PubS_TMONEY_IP  = "27.102.213.207"; //운영서버IP
	int PubI_TMONEY_PORT = 62001;
...
<%
	DaouTmoneyAPI payTmoney = new DaouTmoneyAPI(PubS_TMONEY_IP,PubI_TMONEY_PORT);
	...
	struct.PubSet_Function			= PayInfo.PubCONST_FUNCTION_CANCEL; 
	...
	struct = payTmoney.TmoneyCancel(struct, PubS_LOGDIR+CPID);	
