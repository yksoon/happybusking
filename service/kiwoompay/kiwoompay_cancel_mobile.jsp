...
<%@page import="com.daou.auth.mobile.DaouMobileAPI"%>
...
<%
	//개발서버
	//String PubS_MOBILEIP = "123.140.121.205";
	//실서버
	String PubS_MOBILEIP  = "27.102.213.207";
	int PubI_MOBILEPORT = 43001;
...
<%
	...
	DaouMobileAPI payMobile = new DaouMobileAPI(PubS_MOBILEIP,PubI_MOBILEPORT);
	...
	struct = payMobile.MobileCancel(struct, PubS_LOGDIR+"/"+CPID);	
