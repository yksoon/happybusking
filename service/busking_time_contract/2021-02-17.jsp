...
<%
	try{
		...
		sql = "SELECT a.PERFORM_NO, a.TEAM_NO, a.MATCHING_CHK, c.TEAM_NAME, b.BUSKINGDATE, b.STARTINGTIME, b.FINISHINGTIME, b.DAYOFTHEWEEK, b.OFFERPRICE, c.TINTRO_IMG " + "\r\n" +
				"FROM   reg_perform a " + "\r\n" +
