 		...
 		if (rs.next()) {
 			...
 			*/
 			...
 			if (ConvertUtil.toStr(rs.getString("USER_ACTIVE")).equals("Y") == true) {
                ...
                session.setAttribute("OWNER_CHK", ConvertUtil.toStr(rs.getString("OWNER_CHK")));
 				...
 				String user_no = ConvertUtil.toStr(rs.getString("USER_NO"));
                ...
                String owner_chk = ConvertUtil.toStr(rs.getString("OWNER_CHK"));
                ...
                Cookie c12 = new Cookie("owner_chk", owner_chk); 
